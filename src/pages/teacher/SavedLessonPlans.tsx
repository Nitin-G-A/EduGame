    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold flex items-center gap-2">
          <Lightbulb className="w-8 h-8 text-primary" /> Saved Lesson Plans
        </h1>
        <p className="text-muted-foreground mt-1">View and manage your AI-generated lesson plans</p>
      </div>
      ...
      {lessonPlans.length === 0 ? (
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground">Generate and save lesson plans from the AI Lesson Planner.</p>
          </CardContent>
        </Card>
      ) : (
                ...
                <div className="flex gap-2">
                  <Dialog>
                    ...
                    <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
                      <DialogHeader><DialogTitle>{plan.unit_name}</DialogTitle></DialogHeader>
                      <div className="space-y-6 mt-4">
                        ...
                        <div>
                          <h4 className="font-medium flex items-center gap-2 mb-3">
                            <BookOpen className="w-4 h-4 text-primary" /> Teaching Activities
                          </h4>
                        ...
                        <div>
                          <h4 className="font-medium flex items-center gap-2 mb-3">
                            <AlertTriangle className="w-4 h-4 text-destructive" /> Common Student Mistakes
                          </h4>
                        ...
                        <div>
                          <h4 className="font-medium flex items-center gap-2 mb-3">
                            <HelpCircle className="w-4 h-4 text-primary" /> Quick Quiz Questions
                          </h4>
                        ...
                        {plan.class_flow && (
                          <div>
                            <h4 className="font-medium flex items-center gap-2 mb-3">
                              <Clock className="w-4 h-4 text-primary" /> Suggested Class Flow
                            </h4>
